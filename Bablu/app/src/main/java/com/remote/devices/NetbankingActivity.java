...
public class NetbankingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button loginAndPayButton = findViewById(R.id.pay_now_button);
        loginAndPayButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NetbankingActivity.this, NetbankingLoginActivity.class);
